    ...
    $(function () {
        ...
        $.get("json/world.json", function (worldjson) {
            ...
            $("#jClick2").click(function () {
                ajaxDataCancle("json/2012.json", worldjson);
            });
            $("#jClick3").click(function () {
                ajaxDataCancle("json/2013.json", worldjson);
            });
            $("#jClick4").click(function () {
                ajaxDataCancle("json/2014.json", worldjson);
            });
            $("#jClick5").click(function () {
                ajaxDataCancle("json/2015.json", worldjson);
            });
            $("#jClick6").click(function () {
                ajaxDataCancle("json/2016.json", worldjson);
            });
